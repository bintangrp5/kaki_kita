    ...
    <div class="container my-5">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                        ...
                        <div class="cart-item d-flex align-items-center mb-3 border-bottom pb-3">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="cart-item-price mb-0 text-muted">
                                    Rp.{{ number_format($item->itemable->price, 0, ',', '.') }}
                                </p>
                            </div>
                            ...
                            <div class="d-flex align-items-center">
                                <form action="{{ route('cart.update', $item->id) }}" method="POST" class="d-inline-flex me-2">
                                    ...
                                    <input type="text" name="quantity" value="{{ $item->quantity }}"
                                        class="form-control form-control-sm text-center mx-1" style="width: 50px;" readonly>
                ...
                <a href="{{ URL::to('/products') }}" class="btn btn-outline-primary mt-2">
