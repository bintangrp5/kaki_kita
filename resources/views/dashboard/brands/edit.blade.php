<x-layouts.app :title="__('Edit Brand')">
    <div class="relative mb-6 w-full">
        ...
        <flux:subheading size="lg" class="mb-6">Perbarui informasi merek produk</flux:subheading>
    ...
    <form action="{{ route('brands.update', $brand->id) }}" method="post" enctype="multipart/form-data">
        ...
        <flux:textarea
            ...
            name="description"
            class="mb-3"
            placeholder="Description about the brand">{{ old('description', $brand->description) }}</flux:textarea>
        ...
        <div class="mt-4">
            ...
            <flux:link href="{{ route('brands.index') }}" variant="ghost" class="ml-3">Batalkan</flux:link>
        </div>
    </form>
</x-layouts.app>