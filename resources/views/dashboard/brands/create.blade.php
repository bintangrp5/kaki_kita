<x-layouts.app :title="__('Brands')">
    <div class="relative mb-6 w-full">
        <flux:heading size="xl">Tambah Brand Baru</flux:heading>
        <flux:subheading size="lg" class="mb-6">Manajemen merek produk Anda</flux:subheading>
    ...
    <form action="{{ route('brands.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mt-4">
            ...
            <flux:link href="{{ route('brands.index') }}" variant="ghost" class="ml-3">Kembali</flux:link>
        </div>
    </form>
</x-layouts.app>